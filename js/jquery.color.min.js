    ...
    return null == value
      ...
      : ((value = type.floor ? ~~value : parseFloat(value)),
        type.mod
          ...
          : Math.min(type.max, Math.max(0, value)));
  }
  ...
  each(spaces, function (spaceName, space) {
    ...
    (color.fn = jQuery.extend(color.prototype, {
      parse: function (red, green, blue, alpha) {
        ...
        return (
          green !== undefined &&
            ((red = [red, green, blue, alpha]), (type = "array")),
          "string" === type
                  ...
                  : function (_spaceName, space) {
                      ...
                      each(space.props, function (key, prop) {
                        ...
                        inst[cache] &&
                          ...
                          (null == inst[cache][3] && (inst[cache][3] = 1),
              ...
              (null === startValue
                ...
                : (type.mod &&
                    (endValue - startValue > type.mod / 2
                      ? (startValue += type.mod)
                      : startValue - endValue > type.mod / 2 &&
                        (startValue -= type.mod)),
                  (result[index] = clamp(
      ...
      return (
        (h =
          min === max
            ...
            ? (60 * (b - r)) / diff + 120
            : (60 * (r - g)) / diff + 240),
        (s = 0 === diff ? 0 : l <= 0.5 ? diff / add : diff / (2 - add)),
    ...
    each(spaces, function (spaceName, space) {
      ...
      (color.fn[spaceName] = function (value) {
        ...
        return (
          ...
          from
            ? (((ret = color(from(local)))[cache] = local), ret)
            : color(local)
        );
      }),
        each(props, function (key, prop) {
            ...
            (color.fn[key] = function (value) {
              ...
              return (
                ...
                "undefined" === vtype
                  ? cur
                  : ("function" === vtype &&
                      (vtype = getType((value = value.call(this, cur)))),
      ...
      each(hooks, function (_i, hook) {
        (jQuery.cssHooks[hook] = {
          set: function (elem, value) {
            var parsed;
            "transparent" === value ||
              ("string" === getType(value) && !(parsed = stringParse(value))) ||
              (value = (value = color(parsed || value)).toRgbaString()),
